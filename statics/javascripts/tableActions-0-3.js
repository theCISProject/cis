/*
        Table actions plug-in v0.3 by frequency-decoder.com
...
var fdTableActions = {
        ...
        clickEvent:function(e) {
                ...
                if(!fdTableActions.tableCache[this.id].rowSelectCallback) { return; };
                ...
                if(typeof func == "function") {
                        func({"table":this, "cell":cell, "rows":fdTableActions.tableCache[this.id].trCache.concat([])});
                        return;
                };
                func = null;
        },
