...
class Book(models.Model):
    ...
    report_detail = models.OneToOneField(Detail, verbose_name="Report Details")
    investigation_number = models.IntegerField(verbose_name="Investigation Number",null=True,help_text="Investigation number")
    action = models.ForeignKey(Action, verbose_name="Action details",blank=True)
    accused = models.ForeignKey(Accused,blank=True)
    arrest = models.ForeignKey(Arrest,blank=True)
